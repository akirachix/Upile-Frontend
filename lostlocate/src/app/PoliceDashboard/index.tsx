...
//   // Add a fallback to handle cases where metrics might be undefined
...
//       <div className="flex flex-wrap gap-16 mt-10 nesthub:mt-[8px] nesthub:ml-[14px] nesthubmax:mt-[12px] nesthub:gap-[24px] nesthubmax:ml-4 nesthubmax:gap-20">
//         <div className="bg-[#D4B337] text-white text-center text-[24px] font-bold p-6 rounded-lg shadow-md w-[400px] h-[200px]
//           nesthub:w-[180px] nesthub:h-[100px] nesthub:text-[16px]
