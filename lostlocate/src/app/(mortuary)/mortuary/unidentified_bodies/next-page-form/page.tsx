...
//         <form onSubmit={handleSubmit(onSubmit)} className="bg-white ml-[330px] p-16 rounded-lg shadow-md w-[930px] h-[820px] border-2 border-red-800">
...
//             <button type="button" onClick={() => router.push('/mortuary/unidentified_bodies/first-page-form')} className="bg-[#D4B337] text-white px-6 py-3 rounded-md text-lg font-semibold hover:bg-yellow-600">Previous</button>
//             <button 
//               type="submit" 
