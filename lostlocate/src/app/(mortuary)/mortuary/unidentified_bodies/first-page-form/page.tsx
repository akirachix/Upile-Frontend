...
const AddNewBodyForm = () => {
  ...
  return (
    <Layout>
      <div className="flex justify-center items-center mt-6 lg:ml-[300px] 2xl:ml-[300px] 2xl:mt-14 bg-gray-100 p-4">
        <form
        ...
        >
          ...
          <div className="mb-6 flex flex-col md:flex-row items-center">
            <label htmlFor="staff_id" className="w-full md:w-40 text-lg md:text-[24px] font-semibold text-black-700">Staff ID:</label>
            <input
              {...register('staff_id', { valueAsNumber: true })} 
              type="number"
              className={`block w-full h-[60px] mt-2 md:mt-0 px-4 py-3 rounded-md bg-[#EEE0AF] border-[#D4B337] shadow-sm text-lg ${errors.staff_id ? 'border-red-500' : 'border-gray-300'}`}
            />
          </div>
          ...
          <div className="mb-6 flex flex-col md:flex-row items-center">
            ...
            <input
              ...
              className={`block w-full h-[60px] mt-2 md:mt-0 px-4 py-3 rounded-md bg-[#EEE0AF] border-[#D4B337] shadow-sm text-lg ${errors.name ? 'border-red-500' : 'border-gray-300'}`}
            />
          </div>
          ...
          <div className="mb-6 flex flex-col md:flex-row items-center">
            ...
            <select
              {...register('gender')}
              className={`block w-full h-[60px] mt-2 md:mt-0 px-4 py-3 rounded-md bg-[#EEE0AF] border-[#D4B337] shadow-sm text-lg ${errors.gender ? 'border-red-500' : 'border-gray-300'}`}
            >
          ...
          <div className="mb-6 flex flex-col md:flex-row items-center">
            ...
            <select
              {...register('location')}
              className={`block w-full h-[60px] mt-2 md:mt-0 px-4 py-3 rounded-md bg-[#EEE0AF] border-[#D4B337] shadow-sm text-lg ${errors.location ? 'border-red-500' : 'border-gray-300'}`}
            >
          ...
          <div className="mb-6 flex flex-col md:flex-row items-center">
            ...
            <input
              ...
              max={today} 
              className={`block w-full h-[60px] mt-2 md:mt-0 px-4 py-3 rounded-md bg-[#EEE0AF] border-[#D4B337] shadow-sm text-lg ${errors.reporting_date ? 'border-red-500' : 'border-gray-300'}`}
            />
          </div>
